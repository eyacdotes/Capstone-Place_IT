    ...
    <div class="w-full py-6 flex justify-center">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow-sm sm:rounded-lg border border-gray-300">
                ...
                <!-- Importance of Feedback Message -->
                <div class="text-center mb-4">
                    <p class="text-sm text-gray-600">
                        Your feedback is valuable to us and helps improve our system, PlaceIt. 
                        Please share your experience to help us grow and serve you better!
                    </p>
                </div>
                ...
                <form action="{{ route('space.submit') }}" method="POST" class="mt-6">
                    @csrf
                    <input type="hidden" name="renterID" value="{{ auth()->user()->userID }}">
