                    ...
                    <table class="w-full border-seperate" style="border-spacing: 0;">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-orange-200 text-center">
                                <td class="px-6 py-4 border-b-2 border-orange-200">{{ $history->rentalAgreement->space->title ?? 'N/A' }}</td>
                                <td class="px-6 py-4 border-b-2 border-orange-200">{{ ucwords($history->rentalAgreement->owner->firstName).' '.ucwords($history->rentalAgreement->owner->lastName)?? 'N/A' }}</td>
                                <td class="px-6 py-4 border-b-2 border-orange-200">{{ ucwords($history->rentalAgreement->rentalTerm) ?? 'N/A' }}</td>
                                <td class="px-6 py-4 border-b-2 border-orange-200">{{ number_format($history->rentalAgreement->offerAmount, 2) }}</td>
                                <td class="px-6 py-4 border-b-2 border-orange-200">{{ $history->date }}</td>
                                <td class="px-6 py-4">
