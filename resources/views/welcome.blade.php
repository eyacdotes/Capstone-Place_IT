...
<body class="bg-white font-sans antialiased">
    ...
    <nav class="p-4 bg-white shadow md:flex md:justify-between md:items-center border-b-2">
        ...
        <div class="flex justify-between items-center">
            <a href="{{ url('/') }}" class="hover:text-red-800 text-orange-600 text-3xl" style="font-family: 'Fredoka', sans-serif;">PlaceIt</a>
        ...
        <div class="hidden md:flex md:flex-grow justify-center space-y-4 md:space-y-0 md:space-x-10 mt-4 md:mt-0" id="menu">
            <a href="#top" class="text-m text-gray-400 hover:text-indigo-500  block md:inline-block font-bold">Home</a>
            <a href="#about-us" class="text-m text-gray-400 hover:text-indigo-500  block md:inline-block font-bold">About</a>
            <a href="#contacts" class="text-m text-gray-400 hover:text-indigo-500 md:inline-block font-bold">Contact</a>
...
<!-- About Us Section -->
<section id="about-us" class="bg-white py-12">
    ...
    <!-- Contacts Section -->
    <!-- Contact Us Section -->
<section id="contacts" class="bg-gray-100 py-12">
    <div class="container mx-auto text-center">
        <!-- Title -->
