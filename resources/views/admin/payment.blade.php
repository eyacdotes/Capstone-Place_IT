...
<x-app-layout>
    ...
    <div id="transferModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-6 w-1/3">
            ...
            <form action="{{ route('admin.payments.transfer') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="mobileNumber" class="block text-sm font-medium text-gray-700">Space Owner Mobile Number</label>
                    <input type="text" id="mobileNumber" name="mobileNumber" class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2" readonly />
                </div>
                <div class="mb-4">
    ...
    <script>
        function openModal(paymentID, amount, mobileNumber) {
